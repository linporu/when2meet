    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-8 text-center">建立新活動</h1>
                
                @if ($errors->any())
                    <div class="text-red-600 text-sm bg-red-50 border border-red-200 p-4 rounded-lg mb-6">
                        <ul class="space-y-1">
                ...
                <form id="event-form" method="POST" action="/">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="timezone" name="timezone" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors outline-none" required>
                            <option value="">請選擇時區</option>
                            <option value="Asia/Taipei" {{ old('timezone') == 'Asia/Taipei' ? 'selected' : '' }}>
                                台北 (UTC+8)
                            </option>
                            ...
                            <option value="Asia/Hong_Kong" {{ old('timezone') == 'Asia/Hong_Kong' ? 'selected' : '' }}>
                                香港 (UTC+8)
                            </option>
                            <option value="Asia/Singapore" {{ old('timezone') == 'Asia/Singapore' ? 'selected' : '' }}>
                                新加坡 (UTC+8)
                            </option>
                    ...
                    <div class="mb-6">
                        <button type="submit" class="w-full bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors outline-none">
                            建立活動
                        </button>
                    </div>
                </form>
